...
public class ErudexLogin {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Iterate over the HashMap and get the user names and passwords for
		for (Map.Entry<String, String> entry : users.entrySet()) {
			...
			if (page instanceof StudentDashBoardPage) {
				...
				//selectMockTestTypeGrandTest();SessionUtils.waitFor(3000);
				...
				stuDashBoardPage.testCards();SessionUtils.waitFor(3000);
